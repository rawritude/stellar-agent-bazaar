...
export const SPLASH_ART: TerminalLine[] = [
  ...
  blank(),
  line(span("    ╔═══════════════════════════════════╗", "gold")),
  line(span("    ║", "gold"), span("  T H E  V E L V E T  L E D G E R ", "gold", true), span("║", "gold")),
  line(span("    ║", "gold"), span("          B A Z A A R             ", "amber", true), span("║", "gold")),
  line(span("    ╚═══════════════════════════════════╝", "gold")),
  blank(),
...
const AGENT_ART: Record<string, TerminalLine[]> = {
  ...
  "auntie-null": [
    line(span("      ..", "purple")),
    line(span("    .'  '.", "purple")),
    line(span("   ( o  o )  ", "purple"), span("Auntie Null", "cyan", true)),
    line(span("    \\ ~~ /   ", "purple"), span("Vibe Auditor", "dim")),
    line(span("     \\../", "purple")),
  ],
  "ledger-pup": [
    line(span("    /\\_/\\", "green")),
    line(span("   ( o.o )   ", "green"), span("Ledger Pup 4", "cyan", true)),
  ...
  "marquis-samples": [
    line(span("    _===_", "amber")),
    line(span("   /  |  \\", "amber")),
    line(span("  | (o)(o)|  ", "amber"), span("The Marquis of Samples", "cyan", true)),
    line(span("  |  \\__/ |  ", "amber"), span("Brand Ambassador", "dim")),
...
const DISTRICT_ART: Record<string, TerminalLine[]> = {
  "velvet-steps": [
    line(span("      /\\", "gold")),
    line(span("     /  \\    ", "gold"), span("The Velvet Steps", "gold", true)),
  ...
  "festival-sprawl": [
    ...
    line(span("  |__|_|__|  ", "orange"), span("Pop-up stalls. Brand battles.", "dim")),
    line(span("  ~~~~~~~~~~", "orange")),
  ],
};
...
export const CHAMPIONSHIP_WIN_ART: TerminalLine[] = [
  ...
  line(span("         *    /    /|\\    \\    *", "gold")),
  line(span("          .  /    / | \\    \\  .", "gold")),
  line(span("         *  /____/__|__\\____\\  *", "gold")),
  line(span("          .   ||  |||  ||   .", "amber")),
  line(span("         *    ||  |||  ||    *", "amber")),
  line(span("          ~~~~~~~~~~~~~~~~~~~~", "gold")),
  blank(),
...
export const BANKRUPTCY_ART: TerminalLine[] = [
  blank(),
  line(span("          _________________", "red")),
  line(span("         |     CLOSED      |", "red")),
  line(span("         |  _____________  |", "dim")),
  line(span("         | |  X       X  | |", "dim")),
  line(span("         | |    BOARD    | |", "dim")),
  line(span("         | |     UP     | |", "dim")),
  line(span("         | |_____________| |", "dim")),
  line(span("         |___|_________|___|", "red")),
  line(span("              |||   |||", "dim")),
  blank(),
...
export const MARKET_CRASH_ART: TerminalLine[] = [
  ...
  line(span("         /  |  \\", "red")),
  line(span("        ___|___", "orange")),
  line(span("       /  $$$  \\", "orange")),
  line(span("      / $ $ $ $ \\", "dim")),
  line(span("     /___________\\", "dim")),
  line(span("       \\\\  |  //", "dim")),
  line(span("        \\\\ | //", "dim")),
  blank(),
];
...
export const RIVAL_ARRIVES_ART: TerminalLine[] = [
  ...
  line(span("       /   \\  /   \\", "purple")),
  line(span("      /     \\/     \\", "purple")),
  line(span("     /_______________\\", "purple")),
...
export const FESTIVAL_ART: TerminalLine[] = [
  blank(),
  line(span("     ~*~  ~*~  ~*~  ~*~  ~*~", "orange")),
  line(span("    /\\_/\\ /\\_/\\ /\\_/\\ /\\_/\\", "amber")),
  line(span("   / | | / | | / | | / | |", "amber")),
  line(span("   |_|_| |_|_| |_|_| |_|_|", "amber")),
  line(span("    F E S T I V A L  W E E K", "orange", true)),
  line(span("     ~*~  ~*~  ~*~  ~*~  ~*~", "orange")),
  blank(),
];
...
export const DAWN_ART: TerminalLine[] = [
  line(span("    *  .  .    .  *", "dim")),
  line(span("      .   *  .       .  *", "dim")),
  line(span("  ___________________________", "dim")),
  line(span("  __|__|__|__|__|__|__|__|__|__", "amber")),
  line(span("       _____////\\_____", "gold")),
  line(span("      /////       \\\\\\\\\\", "gold")),
];
...
export const EVENING_ART: TerminalLine[] = [
  ...
  line(span("    .    *   .   *   .", "dim")),
  line(span("  ___________________________", "dim")),
  line(span("  __|__|__|__|__|__|__|__|__|__", "dim")),
  line(span("    \\\\|//  \\\\|//  \\\\|//", "orange")),
  line(span("     |||    |||    ||| lamps", "orange")),
];

export const DOOR_SLAMMED_ART: TerminalLine[] = [
  line(span("    ___________", "red")),
  line(span("   |     / / / |", "red")),
  line(span("   | X / / /   |", "red")),
  line(span("   |_/_/_/_____|", "red")),
  line(span("   SERVICE REFUSED", "red", true)),
];

export const HANDSHAKE_ART: TerminalLine[] = [
  line(span("      ___   ___", "green")),
  line(span("     /   \\_/   \\", "green")),
  line(span("    |  <==>  |", "green")),
  line(span("     \\___/ \\___/", "green")),
...
export const WEEKLY_REPORT_ART: TerminalLine[] = [
  blank(),
  line(span("    ___________________", "amber")),
  line(span("   /                   \\", "amber")),
  line(span("  |  WEEKLY  LEDGER     |", "amber", true)),
  line(span("  |  _______________    |", "amber")),
  line(span("  | |               |   |", "dim")),
  line(span("  | |   Summary     |   |", "dim")),
  line(span("  | |_______________|   |", "dim")),
  line(span("   \\___________________/", "amber")),
  blank(),
];
...
export const SPECIALTY_ART: Record<string, TerminalLine[]> = {
  ...
  investigation: [
    ...
    line(span("     / | \\", "purple")),
    line(span("    (  Q  )", "purple")),
    line(span("   INVESTIGATOR", "dim")),
  ],
  branding: [
    line(span("     _____", "orange")),
    line(span("    /  !! \\", "orange")),
    line(span("   | *  * |", "orange")),
    line(span("    \\_===_/", "orange")),
    line(span("   PROMOTER", "dim")),
  ],
  diplomacy: [
    line(span("     _  _", "green")),
    line(span("    / \\/ \\", "green")),
    line(span("   | <--> |", "green")),
    line(span("    \\____/", "green")),
    line(span("   DIPLOMAT", "dim")),
  ],
};
...
const STELLAR_ART: TerminalLine[] = [
  ...
  line(span("        N E T W O R K", "teal", true)),
];
...
const EVENT_CATEGORY_ART: Record<string, TerminalLine[]> = {
  merchant: [
    ...
    line(span("     /|   |\\", "amber")),
    line(span("    / |___| \\", "amber")),
    line(span("   MERCHANT ENCOUNTER", "gold", true)),
  ],
  stranger: [
    line(span("       .--.", "purple")),
    line(span("      / ?? \\", "purple")),
    ...
    line(span("       ||", "dim")),
    line(span("      /||\\", "dim")),
    line(span("   MYSTERIOUS STRANGER", "purple", true)),
  ],
  disaster: [
    line(span("      /\\/\\", "red")),
    line(span("     / !! \\", "red")),
    line(span("    / !!!!  \\", "red")),
    line(span("   /________\\", "red")),
    line(span("   \\  ||||  /", "orange")),
    line(span("    \\______/", "orange")),
    line(span("   MARKET DISRUPTION", "red", true)),
  ],
  celebration: [
    line(span("    *  ~  *  ~  *", "orange")),
    line(span("   ~ * ~ * ~ * ~", "gold")),
  ...
  agent: [
    ...
    line(span("      /|\\", "dim")),
    line(span("     / | \\", "dim")),
    line(span("   AGENT EVENT", "cyan", true)),
  ],
  mystery: [
    line(span("      _____", "purple")),
    line(span("     |  ?  |", "purple")),
    line(span("     | ??? |", "purple")),
    line(span("     |  ?  |", "purple")),
    line(span("     |_____|", "purple")),
